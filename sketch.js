...
function keyPressed() {
  if(keyCode === 32){
    // create an arrow object and add into an array ; set its angle same as angle of play
var playerArcher=new PlayerArcher(player.x,player.y);
arrow.push(playerArcher);
  }
}
